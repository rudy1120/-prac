...
<body>
	<h3 class="tit" style="font-size:3em;margin-bottom:20px;">분양정보 알림서비스 신청</h3>
	...
	<div class="all_wrap">
		<div class="inr vision">
			...
			<p class="box-comment"><strong class="strong_st">분양 알림서비스 철회</strong><br>SMS철회 페이지 입니다.</p>
			</div>
		</div>
		<div class="bt_wrap">
			<a href="/bmc/apply/applyForm.do" class="bt bt1" title="분양 알림서비스 신청">SMS 신청</a>
			<a href="/bmc/apply/updtForm.do" class="bt bt2" title="분양 알림서비스 수정">SMS 수정</a>
			<a href="/bmc/apply/delForm.do" class="bt b3 on" title="분양 알림서비스 철회">SMS 철회</a>
		</div>
			...
			<form:form commandName="applySmsVO" name="chkForm" id="chkForm" action="" methodParam="post">
				<fieldset>
					...
					<table class="bod_maintain">
						<caption class="blind">분양정보 알림 서비스(SMS) 철회를 위한 성명, 휴대폰 번호 입력칸으로 이루어진 표</caption>
