...
<div id="subContents">
	<h3 class="tit" style="padding-bottom: 10px;text-align: center;">개인정보처리방침 2019.04.12</h3>
	<p style="text-align: center;padding-bottom: 20px;">적용기간 (2019.04.12 ~ 2020.05.31)</p>
	<div id="contents">
...
<p><strong class="strong_st">1. 부산도시공사에서 보유하고 있는 개인정보 파일</strong></p>
								<table class="orgTable protectTable">
										<tbody>
												<tr><th colspan="5">개인정보파일 및 상세내용</th></tr>
												<tr><th width="20%">개인정보파일</th><th width="*">보유근거</th><th width="20%">보유목적</th><th width="20%">주요항목</th><th width="10%">보유기간</th></tr>
												<tr>
														<td>주택임대</td>
												...
												<tr>
														...
														<td scope="col">과세자료제출 및 관리에 관한<br />법률시행령 제6조</td>
												...
												<tr>
														...
														<td scope="col">공익사업을 위한 토지등 취득 및<br />보상에 관한 법률 제8조 ,<br />동법시행령 제6조,제50조의2</td>
												...
												<tr>
														...
														<td scope="col">국가를당사자로하는 계약에 관한<br />법률 시행령 제116조</td>
														<td scope="col">계약자 신상정보 관리</td>
														<td scope="col">성명,주소,주민번호<br />,연락처,사업자등록번호</td>
														<td scope="col">영구</td>
												</tr>
												<tr>
														<td scope="col">고객의 소리(VOC)<br />민원사항관리</td>
														<td scope="col">공공기록물 관리에 관한 법률시행령 제25조, 제26조</td>
														<td scope="col">민원처리</td>
														<td scope="col">성명,연락처,E-Mail</td>
														<td scope="col">영구</td>
												</tr>
										</tbody>
								</table>
								...
								<ul class="amendsUl">
										<li>개인정보보호 종합포털(<a href="/www.privacy.go.kr" target="blank">www.privacy.go.kr</a>)에서, 개인정보민원 ▷ 개인정보의 열람 등 요구 ▷개인정보파일 목록 검색 ▷ 기관명 입력 후 조</li>
								</ul>
						...
						<div class="inr vision">
							<div class="area_box box2">
								...
								<table class="orgTable protectTable">
										<tbody>
												<tr><th colspan="5">개인정보파일 및 상세내용</th></tr>
												<tr><th width="15%">제공받는 자</th><th width="20%">제공근거</th><th width="20%">개인정보 이용목적</th><th width="*">제공하는 개인정보의 항목</th><th width="15%">보유/이용 기간</th></tr>
												<tr>
														<td scope="col">금융결제원</td>
														<td scope="col">한국토지주택공사법 <br />시행령 제42조, 주택법 <br />제38조의 7 및 주택공급에 <br />관한 규칙 제24조,제50조,<br />제52조,제57조</td>
														<td scope="col">가입은행&middot;입주자저축 <br />순위&middot;저축금액&middot;<br />납입인정금액&middot;<br />납입인정횟수<br /> 조회, 주택소유여부 및 <br />무주택기간 조회, <br />과거당첨사실 조회, <br />재당첨제한 관리</td>
														<td scope="col">무주택기간, 거주지역, <br />거주시작일, <br />입주자저축정보<br />(계좌번호, 순위, 저축금액 등),<br /> 이름, 주민등록번호,<br /> 세대원의 신청자와의<br /> 관계, 신청자가 속한 <br />세대주와의 관계, 세대원 이름,<br /> 세대원 주민등록번호, <br />주소, 휴대전화번호,<br /> 일반전화번호, 이메일</td>
														<td scope="col">10년</td>
												</tr>
												<tr>
														<td scope="col">한국보건복지정보개발원</td>
														<td scope="col">공공주택특별법 제48조</td>
														<td scope="col">소득자산 조회</td>
														<td scope="col">성명, 주민등록번호, 주소, <br />세대원,세대원주민번호,<br /> 핸드폰번호, 이메일</td>
														<td scope="col">10년</td>
												</tr>
												<tr>
														<td scope="col">국세청</td>
														<td scope="col">개인정보보호법제18조 제2항 제2호, <br />과세자료의 제출 및 관리에 <br />관한 법률 제5조 및 제8조, <br />국세기본법 제85조</td>
														<td scope="col">국세부과 및 <br />납세관리에 활용</td>
														<td scope="col">성명, 주민등록번호,<br /> 계좌번호, 수령금액</td>
														<td scope="col">과세자료로 5년</td>
												</tr>
												<tr>
														<td scope="col">보건복지부</td>
														<td scope="col">공공주택특별법 제48조의 3</td>
														<td scope="col">임대주택의 <br />중복 입주 등의 확인</td>
														<td scope="col">성명, 주민등록번호, 주소</td>
														<td scope="col">당첨자 : 5년,<br />계약자 : 영구</td>
												</tr>
												<tr>
														<td scope="col">지자체</td>
														<td scope="col">개인정보보호법 제18조 제2항 제2호,<br />지방세기본법제134조의6</td>
														<td scope="col">주민등록등본발급,<br /> 지방세, 재산세 부과</td>
														<td scope="col">성명, 주민등록번호,<br /> 계약내역, 완납내역, <br />계약 및 수납내역(명의변경 포함), <br />보상금지급내역</td>
														<td scope="col">과세자료로 5년</td>
												</tr>
												<tr>
														<td scope="col">국민권익 위원회</td>
														<td scope="col">개인정보보호법 제18조제2항 제2호,<br /> 부패방지 및 국민권익위원회의<br /> 설치와 운영에 관한 법률 <br />제12조제6호, 제29조제1항</td>
														<td scope="col">공공기관의 <br />청렴도 평가를 위한 <br />민원인 및 직원에 대한 설문조사 실시</td>
														<td scope="col">건설공사점검&middot;토지 보상<br /> 및 공급&middot;품질검사&middot;<br />임대주택단지관리&middot;아파트시설물 유지보수&middot;<br />용역관리감독의 민원인 및 <br />소속 직원의 성명, 전화번호, 이메일</td>
														<td scope="col">재계약기간 2년<br />/<br />해당년도 청렴도<br />조사완료시까지</td>
												</tr>
										</tbody>
								</table>
							</div>
						...
						<div class="inr vision">
							<div class="area_box box2">
								...
								<table class="orgTable protectTable">
										<tbody>
												<tr><th width="20%">위탁하는 업무 내용</th><th width="*">취급개인정보</th><th width="20%">수탁업체</th></tr>
												<tr>
														<td>정보시스템유지보수 및 <br />홈페이지 유지보수</td>
														<td>UBIS 보유 개인정보(성명,주민번호,주소) 및 고객의 소리 정보(성명,전화번호)</td>
														<td>앤시정보기술㈜</td>
												</tr>
												<tr>
														<td rowspan="7">임대주택관리</td>
														<td rowspan="7">입주민관련 개인정보(성명,주민번호,주소)</td>
						...
						<div class="inr vision">
							...
							<p>부산도시공사는 「개인정보보호법」제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적, 관리적, 물리적 조치를 하고 있습니다.</p>
								...
								<ul class="amendsUl">
										<li>부산도시공사는 &lsquo;개인정보의 안전성 확보조치 기준&rsquo;(행정안전부고시 제2019-제47호)에 의거하여 내부관리계획(&lsquo;19.07)을 수립 및 시행하고 있습니다.</li>
								</ul>
						...
						<div class="inr vision">
							<div class="area_box box2">
								<p><strong class="strong_st">이 개인정보처리방침은 2019.04.12 부터 적용됩니다.</strong></p>
