...
public class EgovKnoSpecialistController {
	...
	public String insertKnoSpecialist(
		...
		if (knoSpecialist.getSpeId() == null
			...
			List MapTeamList = (List) mapTeamService.selectMapTeamList(searchVO);
			...
			// 아이디 설정
			knoSpecialist.setFrstRegisterId((String) loginVO.getUniqId());
			knoSpecialist.setLastUpdusrId((String) loginVO.getUniqId());
