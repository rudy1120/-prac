...
<div id="subContents">
	<h3 class="tit" style="padding-bottom: 10px;text-align: center;">개인정보처리방침 2022.03.31</h3>
	<p style="text-align: center;padding-bottom: 20px;">적용기간 (2022.03.31 ~ 2022.05.11)</p>
	<div id="contents">
				...
				<div class="inr vision">
						<div class="area_box box2">
								...
								<table class="orgTable protectTable"><caption>개인정보처리 위탁 시 위탁하는 업무 내용, 취급개인정보, 수탁업체 안내</caption><colgroup> <col style="width: 20%;" /> <col style="width: 60%;" /> <col style="width: 20%;" /> </colgroup>
										...
										<tbody>
												<tr>
														<td>통합정보시스템 및 <br />홈페이지 유지관리</td>
														<td>통합정보시스템 및 홈페이지(고객의소리) 보유 개인정보</td>
														<td>앤시정보기술㈜</td>
												</tr>
<!-- 												<tr>
														<td>정보시스템<br />유지보수 용역</td>
														<td>정보시스템 유지보수와 관련하여 취급하는 개인정보</td>
														<td>㈜늘푸른정보기술</td>
												</tr>
																																				<tr>
														<td>기록관리시스템<br />유지보수</td>
														<td>기록관리시스템 보유 개인정보</td>
														<td>엔지스인포텍㈜</td>
												</tr> -->
												<tr>
														<td>전세계약 및 채권관리 업무</td>
														<td>임대계약자 개인정보</td>
														<td>법무사 노원우<br />사무소</td>
												</tr>												
												<tr>
														<td rowspan="6">임대주택 및 상가관리</td>
														<td rowspan="6">임대계약자 개인정보</td>
														<td>㈜장천</td>
												</tr>
												<tr>
														<td>주식회사 우봉라이프</td>
												...
												<tr>
														<td rowspan="2">고지서, 독촉장 등 우편발송</td>
														<td rowspan="2">임대계약자 개인정보</td>
														<td>㈜디앤디</td>
												</tr>
												<tr>
														<td>㈜세정정보시스템</td>
