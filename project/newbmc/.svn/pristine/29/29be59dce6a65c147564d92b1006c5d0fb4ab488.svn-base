...
<div id="subContents">
	<h3 class="tit" style="padding-bottom: 10px;text-align: center;">개인정보처리방침 2016.12.28</h3>
	<p style="text-align: center;padding-bottom: 20px;">적용기간 (2016.12.28 ~ 2019.04.11)</p>
	<div id="contents">
			...
			<div id="container">
				<div class="tab_container">
        			...
        			<!-- TODO 첫번째 메뉴-->
								...
								<table class="orgTable protectTable">
									<tbody>
										...
										<tr>
											...
											<td scope="col" rowspan="4">주택공급 특별법 제48조<br>(공공주택의 공급)</td>
								...
								<table class="orgTable protectTable">
									<tbody>
										...
										<tr>
											...
											<td scope="col">가입은행·입주자저축 <br>순위·저축금액·<br>납입인정금액·<br>납입인정횟수<br> 조회, 주택소유여부 및 <br>무주택기간 조회, <br>과거당첨사실 조회, <br>재당첨제한 관리</td>
											<td scope="col">무주택기간, 거주지역, <br>거주시작일, <br>입주자저축정보<br>(계좌번호, 순위, 저축금액 등),<br> 이름, 주민등록번호,<br> 세대원의 신청자와의<br> 관계, 신청자가 속한 <br>
											세대주와의 관계, 세대원 이름,<br> 세대원 주민등록번호, <br>주소, 휴대전화번호,<br> 일반전화번호, 이메일</td>
											<td scope="col">10년</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td scope="col">건설공사점검·토지 보상<br> 및 공급·품질검사·<br>임대주택단지관리·아파트시설물 유지보수·<br>용역관리감독의 민원인 및 <br>소속 직원의 성명, 전화번호, 이메일</td>
							...
							<div class="area_box box2">
								...
								<table class="orgTable protectTable">
									<tbody>
										...
										<tr>
											<td rowspan="4">임대주택관리</td>
											<td rowspan="4">입주민관련 개인정보(성명,주민번호,주소)</td>
											<td>㈜남부공영</td>
										</tr>
										<tr><td>㈜장천</td></tr>
										<tr><td>㈜삼성티엠티스</td></tr>
						...
						<div class="inr vision">
							<div class="area_box box2">
								...
								또한 만 14세 미만 아동의 법정대리인은 부산도시공사에 그 아동의 개인정보의 열람, 정정·삭제, 처리정지 요구를 할 수 있습니다. 다만, 개인정보처리정지 요구시「개인정보보호법」제 37조 제 2항에 의하여 처리정지 요구가 거절될 수 있습니다.</p>
								...
								<table class="orgTable protectTable">
									<tbody>
										...
										<tr>
											<td>주택임대</td>
											<td rowspan="5">주거복지처</td>
											<td>종합상담실(당사 사옥 1층)</td>
											<td>051-810-1306<br>051-810-1307</td>
											<td></td>
										</tr>
										<tr>
											<td>매입임대</td>
						...
						<div class="inr vision">
							<div class="area_box box2">
								...
								<p>개인정보처리시스템의 접근에 대한 차등 권한 부여 및 시스템 접속에 대한 접근 통제를 실시하고 있으며, 침입차단시스템 등 정보보안시스템을 이용하여 외부로부터의 무단 접근을 방지하고 있고, 개인정보취급자가 정보통신망을 통해 
								외부에서 개인정보처리시스템에 접속하는 경우에는 가상사설망(VPN:Virtual Private Network)을 이용하고 있습니다.</p>
						...
						<div class="inr vision">
							<div class="area_box box2">
								<p><strong class="strong_st">이 개인정보처리방침은 2017.05.24 부터 적용됩니다.</strong></p>
					...
					<div id="tab2" class="tab_content">
						...
						<div class="inr vision">
							<div class="area_box box2">
								<p>귀하는 개인영상정보에 관하여 열람 또는 존재확인·삭제를 원하는 경우 언제든지 영상정보처리기기 운영자에게 요구하실 수 있습니다. 단, 귀하가 촬영된 개인영상정보 및 명백히 정보주체의 급박한 생명, 신체, 재산의 이익을 위하여 
								필요한 개인영상정보에 한정됩니다. 본 기관은 개인영상정보에 관하여 열람 또는 존재확인·삭제를 요구한 경우 지체 없이 필요한 조치를 하겠습니다.</p>
							</div>
						</div>
