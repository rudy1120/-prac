...
<script type="text/javascript" charaset="UTF-8">
	...
	function excelDown(){
		...
		var searchTxt = $("#searchTxt").val();
		 ...
		 location.href= "/sys/webzine/ExcelDownloader.do?searchType="+searchType+"&searchTxt="+encodeURI(searchTxt,"UTF-8");
