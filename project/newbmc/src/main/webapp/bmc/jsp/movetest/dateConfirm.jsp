...
<c:set var="successUrl" value="/bmc/movetest/dateConfirm.do" />
...
<body>
	...
	<div class="all_wrap">
		<div class="inr vision">
			...
			<p class="box-comment"><strong class="strong_st">이사날짜 예약</strong><br>날짜 확인 페이지 입니다.</p>
			</div>
		</div>
		...
		<c:choose>
			<c:when test="${not empty user}">
				...
				<form:form commandName="MoveTestVO" id="confirmForm" name="confirmForm" action="/bmc/movetest/chkResUp.do" 
