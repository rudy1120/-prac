...
<body>
	...
	<c:if test="${empty(user.userName)}"><c:set var="user" value="${null}"/></c:if>
		...
		<form:form commandName="MoveTestVO" id="resForm" name="resForm" action="/bmc/movetest/reserve.do"
			...
			<div class="bod_wrap">
				<fieldset>
					<div class="bod_write-il">
						<input type="hidden" id="cust_id" name="cust_id" value="${resultList.cust_id}"/>
						<dl>
