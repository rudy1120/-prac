...
function init(){
	...
	var confmKey = "U01TX0FVVEgyMDIyMTIyMDE5NDcyNjExMzM1ODA="; // 연계신청시 부여받은 승인키 입력(테스트용 승인키 : TESTJUSOGOKR)
	...
	if(inputYn != "Y"){
		...
		opener.jusoCallBack2("<%=roadFullAddr%>","<%=roadAddrPart1%>","<%=addrDetail%>","<%=roadAddrPart2%>", 
