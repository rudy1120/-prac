...
<div id="subContents">
	<h3 class="tit" style="padding-bottom: 10px;text-align: center;">개인정보처리방침 2020.06.01</h3>
	<p style="text-align: center;padding-bottom: 20px;">적용기간 (2020.06.01 ~ 2020.11.25)</p>
	<div id="contents">
							...
							<div class="area_box box2">
								...
								<table class="orgTable protectTable">
										<tbody>
												...
												<tr>
														<td>이메일</td>
														<td>jtae3936@bmc.busan.kr</td>
														<td>jhyun@bmc.busan.kr</td>
												</tr>
										</tbody>
								</table>
							</div>
