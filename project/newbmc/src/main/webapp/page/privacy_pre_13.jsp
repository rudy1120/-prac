...
<div id="subContents">
	<h3 class="tit" style="padding-bottom: 10px;text-align: center;">개인정보처리방침 2022.05.12</h3>
	<p style="text-align: center;padding-bottom: 20px;">적용기간 (2022.05.12 ~ 미정)</p>
	<div id="contents">
						...
						<div class="area_box box2">
								...
								<table class="orgTable protectTable"><caption>개인정보파일의 개인정보파일명, 보유근거, 보유목적, 주요항목, 보유기간을 안내</caption><colgroup> <col style="width: 20%;" /> <col style="width: 30%;" /> <col style="width: 20%;" /> <col style="width: 20%;" /> <col style="width: 10%;" /> </colgroup>
										...
										<tbody>
												<tr>
														<td>주택임대</td>
														<td rowspan="4">공공주택 특별법 제48조,<br />동법 시행령 제63조,<br />주택공급에 관한 규칙 제24조</td>
														<td>주택임대 입주자현황 관리</td>
														<td>성명,주소,주민번호,연락처,<br />세대원정보</td>
														<td>30년</td>
												</tr>
												<tr>
														<td>매입임대</td>
														<td>매입임대 입주자현황 관리</td>
														<td>성명,주소,주민번호,연락처</td>
														<td>30년</td>
												</tr>
												<tr>
														<td>전세임대</td>
												...
												<tr>
														...
														<td>과세자료제출 및 관리에 관한<br />법률시행령 제6조</td>
														<td>계약자 신상정보 관리</td>
														<td>성명,주소,주민번호,연락처,<br />사업자등록번호</td>
														<td>영구</td>
												</tr>
												<tr>
												...
												<tr>
														...
														<td>민원 처리에 관한 법률 제7조,<br />동법 시행령 제11조 및 제52조</td>
														<td>전자민원창구 운영상 민원의 접수·교부</td>
														<td>성명,연락처,E-Mail</td>
														<td>영구</td>
												</tr>
												<tr>
				...
				<div class="inr vision">
						<div class="area_box box2">
								...
								<table class="orgTable protectTable"><caption>개인정보의 제공 시 제공받는 자, 제공근거, 개인정보 이용목적, 제공하는 개인정보의 항목, 보유/이용 기간 안내</caption><colgroup> <col style="width: 15%;" /> <col style="width: 20%;" /> <col style="width: 20%;" /> <col style="width: 30%;" /> <col style="width: 15%;" /> </colgroup>
										<thead>
												<tr><th colspan="5" scope="colgroup">부산도시공사 개인정보 제3자 제공현황</th></tr>
										...
										<tbody>
												<tr>
														<td>금융결제원</td>
														<td>주택법 제38조의 7 및 주택공급에 관한 규칙 제24조,제50조,제52조,제57조</td>
												...
												<tr>
														...
														<td>- 신청자 : 이름, 주민등록(외국인)번호<br />- 세대구성원 : 이름, 주민등록(외국인)번호, 신청자와의 관계</td>
														<td>당첨자 : 5년,<br />계약자 : 영구</td>
												</tr>
												<tr>
														<td>지자체</td>
														<td>개인정보보호법<br />제18조 제2항 제2호,<br />지방세기본법<br />제 134조의 6<br />공공주택 특별법<br />제53조의 2</td>
														<td>주민등록등본발급,<br /> 지방세, 재산세 부과,<br />수급자격 확인</td>
												...
												<tr>
														...
														<td>· ‘토지 등 보상’ 민원인<br />- 성명, 전화번호, 보상금신청일, 보상금액<br />· 임대주택 계약자<br />- 성명, 전화번호, (재)계약일<br />· 공사·용역·물품 계약자<br />- 계약일, 계약금액, 업체대표자·현장소장·현장대리인·하도급자의 성명, 전화번호, 이메일<br />- 입찰참가자의 성명, 전화번호, 이메일</td>
														<td>해당년도 청렴도<br />조사완료시까지</td>
												</tr>
												<tr>
														<td>임대주택<br />위탁관리업체</td>
														<td>공공주택 특별법 제48조<br />및 제48조의7</td>
														<td>임대주택 입주자 관리</td>
														<td>성명, 주민번호, 연락처, 주소</td>
														<td>[입주자로 선정되지 못한자] : 6개월,<br />[입주대상자] : 임대차계약 체결시까지,<br />[계약자] : 임대차계약기간</td>
												</tr>			
												<tr>
														<td>거주자<br />실태조사 업무<br />수탁자</td>
														<td>공공주택 특별법 제48조<br />및 제48조의7</td>
														<td>거주자 실태조사</td>
														<td>성명, 주민번호, 연락처, 주소</td>
														<td>[입주자로 선정되지 못한자] : 6개월,<br />[입주대상자] : 임대차계약 체결시까지,<br />[계약자] : 임대차계약기간</td>
												...
												<tr>
														<td>고객만족도<br />조사 업무<br />수탁자</td>
														<td>공공기관 운영에 관한 법률<br />제13조 제2항,<br />동법시행령 제17조 제3항</td>
														<td>입주자 고객만족도 조사</td>
														<td>성명, 연락처, 아파트명, 동(호수)</td>
														<td>해당년도 만족도<br />조사완료시까지</td>
												</tr>																																	
										</tbody>
								</table>
						</div>
				...
				<div class="inr vision">
						<div class="area_box box2">
								...
								<table class="orgTable protectTable"><caption>개인정보처리 위탁 시 위탁하는 업무 내용, 취급개인정보, 수탁업체 안내</caption><colgroup> <col style="width: 20%;" /> <col style="width: 60%;" /> <col style="width: 20%;" /> </colgroup>
										...
										<tbody>
												<tr>
														<td>통합정보시스템<br />유지관리 용역</td>
														<td>NBIIS 보유 개인정보(성명, 주민번호, 주소 등)</td>
														<td>앤시정보기술㈜</td>
												</tr>
												<tr>
														<td>홈페이지<br />유지관리 용역</td>
														<td>고객의소리 정보(성명, 전화번호)</td>
														<td>앤시정보기술㈜</td>
												</tr>												
												<tr>
														<td>정보시스템<br />유지보수 용역</td>
														<td>NBIIS 보유 개인정보(성명, 주민번호, 주소 등)</td>
														<td>㈜늘푸른정보기술</td>
												</tr>
												<tr>
														<td>표준기록관리시스템<br />유지보수 용역</td>
														<td>전자결재 등 타시스템 연동관련 개인정보</td>
														<td>엔지스인포텍㈜</td>
												</tr>
												<tr>
														<td>수입금 안내문(고지서) 제작, 인쇄, 봉합 및 발송, 임대주택·상가 임대료 독촉장 등 우편발송서비스</td>
														<td>성명, 주소, 납부금액</td>
														<td>㈜디앤디</td>
												</tr>
												<tr>
														<td>2022년 전세임대<br />업무대행 용역</td>
														<td>전세임대 계약자(이름, 주민번호, 주소, 연락처)</td>
														<td>법무법인 로운</td>
												</tr>
												<tr>
														<td>남부민풀리페<br />국민임대아파트<br />위탁관리 용역</td>
														<td>임대계약자 개인정보</td>
														<td>㈜에이비씨서비스</td>
												</tr>
												<tr>
														<td>동래역 행복주택<br />위탁관리 용역</td>
														<td>임대계약자 개인정보</td>
														<td>㈜에이비씨서비스</td>
												</tr>
												<tr>
														<td>장림에이스밀 임대공장<br />위탁관리 용역</td>
														<td>임대계약자 개인정보</td>
														<td>주식회사 우림종합관리</td>
												</tr>						
												<tr>
														<td>반송지구 영구임대아파트<br />위탁관리 용역</td>
														<td>임대계약자 개인정보</td>
														<td>㈜에이비씨서비스</td>
												</tr>
												<tr>
														<td>덕천2지구<br />영구임대아파트<br />위탁관리 용역</td>
														<td>임대계약자 개인정보</td>
														<td>주식회사 새한티에스</td>
												</tr>
												<tr>
														<td>구포도시 공공임대아파트<br />위탁관리 용역</td>
														<td>임대계약자 개인정보</td>
														<td>주식회사 로이안</td>
												</tr>					
												<tr>
														<td>일광 행복주택</td>
														<td>임대신청자 개인정보(입주자 모집)</td>
														<td>킹스마겐 부동산중개법인</td>
												</tr>
												<tr>
														<td>용호 행복주택</td>
				...
				<div class="inr vision">
						...
						<div class="inr vision">
							<!-- <div class="area_box box2">
								...
								<p><a href="javascript:void(window.open('/page/privacy_pre_11.jsp', '_blank', 'width=800,height=800,scrollbars=yes'))">2021.04.21 ~ 2022.03.30 적용 지침 (클릭)</a></p>
								<p><a href="javascript:void(window.open('/page/privacy_pre_10.jsp', '_blank', 'width=800,height=800,scrollbars=yes'))">2021.04.21 ~ 2022.03.30 적용 지침 (클릭)</a></p>
							...
							<select id="privacy_select" title="이전지침 클릭" >
								<option value="/page/privacy_pre_12.jsp">2021.03.31 ~ 2022.05.11 이전 적용 지침</option>
								<option value="/page/privacy_pre_11.jsp">2021.04.21 ~ 2022.03.30 이전 적용 지침</option>
								<option value="/page/privacy_pre_10.jsp">2021.02.18 ~ 2021.04.20 이전 적용 지침</option>
