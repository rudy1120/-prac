...
<body>
	<h3 style="font-size:3em;margin-bottom:20px;" class="tit">분양 알림서비스 신청</h3>
	...
	<div class="all_wrap">
		<div class="inr vision">
			...
			<p class="box-comment"><strong class="strong_st">분양 알림서비스 신청</strong><br>SMS신청 페이지 입니다.</p>
			</div>
		</div>
		<div class="bt_wrap">
			<a href="/bmc/apply/applyForm.do" class="bt bt1 on" title="분양 알림서비스 신청">SMS 신청</a>
			<a href="/bmc/apply/updtForm.do" class="bt bt2" title="분양 알림서비스 수정">SMS 수정</a>
			<a href="/bmc/apply/delForm.do" class="bt bt3" title="분양 알림서비스 철회">SMS 철회</a>
		</div>
		<div class="form_wrap">
			...
			<div class="nppfs-elements" style="display:none;"></div>
				<fieldset>
					...
					<table class="bod_maintain">
						<caption class="blind">분양정보 알림 서비스(SMS) 신청을 위한 성명, 휴대폰 번호, 공급용도, 개인정보 수집동의로 이루어진 표</caption>
							<thead>
								...
								<td>
									<c:forEach var="uses" items="${resultList}" varStatus="status">
	 									<div style="display:inline-block;width:29%; vertical-align: top">
	 										<c:choose>
	 											<c:when test="${uses.idx eq 80}">
													<label for="${uses.idx}" style="display:none;">
