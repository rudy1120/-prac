...
public class ContentsDao {
	...
	@Value("#{kframework['contentsHilight']}") private String contentsHilight;
	...
	public ResultListVO restSearch(ParameterVO param) throws Exception {
		...
		String from = "contents.contents"; //검색 대상 볼륨,테이블
		...
		searchVO.setHilightFileds(URLEncoder.encode(contentsHilight, "UTF-8"));
