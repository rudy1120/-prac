...
public class UserVO extends CommonVO {
	...
	public UserVO(String userId, String privatecode) {
		setUserId(userId);
	...
	public String toString() {
		return "UserVO [privatecode=" + privatecode + ", parentPrivatecode=" + parentPrivatecode + ", parentName="
				+ parentName + ", userId=" + userId + ", userName=" + userName + ", password=" + password + ", tel1="
				+ tel1 + ", tel2=" + tel2 + ", tel3=" + tel3 + ", birthday=" + birthday + ", gender=" + gender
				+ ", loginCount=" + loginCount + ", lastestLoginDt=" + lastestLoginDt + ", lastPwChangeDate="
				+ lastPwChangeDate + ", createDate=" + createDate + ", updateDate=" + updateDate + ", isDormant="
				+ isDormant + ", confirm=" + confirm + ", newPassword=" + newPassword + ", retypePw=" + retypePw
				+ ", userType=" + userType + ", adminId=" + adminId + ", age=" + age + ", encryptedPw=" + encryptedPw
				+ ", encryptedRetypePw=" + encryptedRetypePw + ", encryptedNewPw=" + encryptedNewPw + "]";
	}
