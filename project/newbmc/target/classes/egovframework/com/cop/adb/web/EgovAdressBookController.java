...
public class EgovAdressBookController {
	...
	private static final Logger LOG = Logger.getLogger(EgovAdressBookController.class.getClass());
	...
	public String addUser(@ModelAttribute("searchVO") AdressBookVO adbkVO, @ModelAttribute("adbkUserVO") AdressBookUserVO adbkUserVO,
		...
		if (checkCnd.equals("regist")) return "egovframework/com/cop/adb/EgovAdressBookRegist";
		else {
