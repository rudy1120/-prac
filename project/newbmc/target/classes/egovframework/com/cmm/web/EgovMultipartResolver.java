...
public class EgovMultipartResolver extends CommonsMultipartResolver {
	...
	protected MultipartParsingResult parseFileItems(List fileItems, String encoding) {
		...
		Map multipartContentsType = new HashMap();
		...
		for (Iterator it = fileItems.iterator(); it.hasNext();) {
			...
			if (fileItem.isFormField()) {
				...
				String curType = (String) multipartParameters.get(fileItem.getContentType());
				multipartContentsType.put(fileItem.getFieldName(), curType);
		...
		return new MultipartParsingResult((MultiValueMap<String, MultipartFile>) multipartFiles, multipartParameters, multipartContentsType);
	}
}
