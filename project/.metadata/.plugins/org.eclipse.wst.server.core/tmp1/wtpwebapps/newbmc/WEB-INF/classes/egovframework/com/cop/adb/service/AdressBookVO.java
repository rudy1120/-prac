 ...
 * </pre>
 */
public class AdressBookVO extends AdressBook implements Serializable {
	...
	/** 주소록구성원 */
	private List<AdressBookUser> adbkMan = new ArrayList<AdressBookUser>();
	 ...
	 * @return the adbkMan
	 */
	public List<AdressBookUser> getAdbkMan() {
		return adbkMan;
	}
	 ...
	 *            the adbkMan to set
	 */
	public void setAdbkMan(List<AdressBookUser> adbkMan) {
