$(function(){
    ...
    //미노출
    if(todate < '2023-08-02 10:00:00'){
    	$("#pop1").remove();
    }
    if(todate < '2023-07-14 09:00:00'){
    	$("#pop3").remove();
    }
    if(todate < '2023-07-17 09:00:00'){
    	$("#pop4").remove();
    }
    if(todate < '2023-08-14 10:00:00'){
    	$("#pop5").remove();
    }
    if(todate < '2023-08-25 09:00:00'){
    	$("#pop6").remove();
    }
    
    //노출
    if(todate > '2023-08-17 18:00:00'){
    	$("#pop1").remove();
    }
    if(todate > '2023-07-31 18:00:00'){
    	$("#pop2").remove();
    }
    if(todate > '2023-07-27 18:00:00'){
    	$("#pop3").remove();
    }
    if(todate > '2023-09-30 18:00:00'){
    	$("#pop4").remove();
    }
...
/* 네번째 팝업 */
	if(cookiedata.indexOf("close4=Y")<0){
	    $("#pop4").show();
	}else{
	    $("#pop4").hide();
	}
...
/* 다섯번째 팝업 */
	if(cookiedata.indexOf("close5=Y")<0){
	    $("#pop5").show();
	}else{
	    $("#pop5").hide();
	}
...
/* 다섯번째 팝업 */
	if(cookiedata.indexOf("close6=Y")<0){
	    $("#pop6").show();
	}else{
	    $("#pop6").hide();
	}
...
var couponClose4 = function(){
    if($("input[name='chkbox4']").is(":checked") == true){
        setCookie("close4","Y",1);   //기간( ex. 1은 하루, 7은 일주일)
    }
    $("#pop4").hide();
}
var couponClose5 = function(){
    if($("input[name='chkbox5']").is(":checked") == true){
        setCookie("close5","Y",1);   //기간( ex. 1은 하루, 7은 일주일)
    }
    $("#pop5").hide();
}
var couponClose6 = function(){
    if($("input[name='chkbox6']").is(":checked") == true){
        setCookie("close6","Y",1);   //기간( ex. 1은 하루, 7은 일주일)
    }
    $("#pop6").hide();
}
